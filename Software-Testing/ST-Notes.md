    ...
    - “顶针”（现代）的观点：敏捷开发
        ...
        - 一个很大的范畴
            ...
            - 极限编程 (XP) [Slides Ch8-1 P15 - P34]
                ...
                - 结对编程
                - 持续集成等
        - 前沿探索：对 TDD 中缺乏高层次设计的补偿——敏捷模型驱动开发 (AMDD) [Book Ch11 P150]
    - 自动化测试简介
        - 为什么需要自动化：软件体量增加，更新频繁，测试需求随之增加，手工测试无法满足测试需求
        - 自动化测试框架的功能分解：测试用例生成，脚本生成，业务流定义，数据配置，测试调度

## 第八节（二） 集成测试与系统测试

- 明确集成测试和系统测试的区别
    - 集成测试主要由开发人员完成，测试的是通过单元测试的模块间的关系是否正确，需要了解程序结构，是一种白盒测试，需要考虑路径覆盖 [[Link]](https://blog.csdn.net/qq_41890041/article/details/109730310)
    - 系统测试需要客户参与，测试的是整个系统的功能是否正确，无需了解程序结构，是一种黑盒测试，需要考虑功能覆盖
- 集成测试的方法
    - 原始的方法（基于功能分解树的集成）
